	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<div class="container">
						<div class="row">
							<div><a style="text-decoration:underline;">我的订单</a> | 	
					...
					<div class="container" style="height:20px;"></div>
						<table class="table table-striped table-hover table-responsive table-bordered" id="customerinfotable">
							<thead>
								<tr>
									<td colspan="14">
										<div class="btn-group">
											...
											<button id="btn_add" type="button" class="btn btn-xs btn-danger"  onclick="BackModel()" >
												<span class="glyphicon glyphicon-arrow-up" aria-hidden="true" >返款</span>
											</button>
											<button id="btn_add" type="button" class="btn btn-xs  btn-success" onclick="ExitModel()" >
								...
								<tr class="active">
								  <th>&nbsp;&nbsp;<input type="checkbox" value="all" id="signedinfo"></th>
								  <th>签单编号</th>
								  <th>签单时间</th>
								  <th>业务类型</th>
								  <th>销售</th>
						...
						<div class="container">
							<div class="row">
								<div id="mysign" class="tcdPageCode sign col-xs-12 col-sm-6 col-md-8 col-lg-6 col-sm-offset-3 col-md-offset-2 col-lg-offset-3"> </div>
							</div>
						</div>
		</div>
	</div>
      ...
      <form action="signed/insertonesign.do" enctype="multipart/form-data" onsubmit="return addsigned()" method="post" class="form-horizontal"> 
	      ...
	      <div class="modal-body">
	       ...
	       <div class="form-group">
		      ...
		      <div class="col-md-8">
		        <textarea class="input-sm form-control" name="sremark" placeholder="" style="width: 100%; height: 73px;resize: none;"></textarea>
		      </div>
		   </div>
		  </div>
	     	<div class="modal-footer" >
...
<div class="modal" id="info" tabindex="-1" role="dialog" aria-labelledby="myModal" aria-hidden="true" >
  <div class="modal-dialog modal-md">
    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	        <h4 class="modal-title"><b>退款申请单</b></h4>&nbsp;&nbsp;&nbsp;
	     </div>       
 <form id="incomeform" class="form-inline" action="signed/UpdateByBack.do" method="post" onsubmit="return submitbyexit()" >
      	 ...
      	 <div class="modal-body">									
				   <div class="container">
			      		<div class="row">
			      			...
			      			<div class="col-xs-3">
			      				<span>经 &nbsp;手 &nbsp;人:</span>
			      				<input name="handler" type="text"  class="form-control" value="">
			      			</div>
		      		 	</div>
		      		 </div>
		      		 &nbsp;&nbsp;
			     ...
			     <div class="container">				  
				   	 <div class="row">
			      		<div class="col-xs-3">
			      				<span>银行卡号：</span>	
    							<input type="text" class="form-control"  name="scustomerbankcardid" id="scustomerbankcardid" required="required">
 						 </div>			      	
			      		<div class="col-xs-3">
			      				<span>身份证号：</span>
			      				<input  type="text"  class="form-control" name="scustomercardid" id="scustomercardid" required="required">
			      		</div>
			      	</div>		 
			     </div>     
			       &nbsp;&nbsp;
			     <div class="container">				  
				   	 <div class="row">
			      		<!-- <div class="col-xs-3">
			      				<span>已交金额：</span>	
    							<input type="text" class="form-control" name="depositfee">
 						 </div>	 -->		      	
			      		<div class="col-xs-3">
			      				<span>退款金额：</span>
			      				<input type="text"  class="form-control" name="backfee" required="required">
			      		</div>
			      	</div>		 
			     </div>  
			      &nbsp;&nbsp;   
			      <div class="container">				  
    					...
    					<label for="remark">退款备注：</label>
    						<textarea class="form-control" name="remark" style="width: 466px; height: 73px;resize: none;" placeholder="备注：请填写原因，时间，操作人。"></textarea>
 					 </div>			      
	     		</div>
	     		<div class="modal-footer">
  ...
  <!-- 返款 -->   
 <div class="modal" id="infoback" tabindex="-1" role="dialog" aria-labelledby="myModal" aria-hidden="true" >
  <div class="modal-dialog modal-md">
    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	        <h4 class="modal-title"><b>返款申请单</b></h4>&nbsp;&nbsp;&nbsp;
	     </div> 
 		<form id="incomeform2" class="form-inline" action="signed/UpdateByBack.do" method="post" onsubmit="return submitbyback()" >
      	<input type="hidden" name="sid" value="">
	       ...
	       <div class="modal-body">
				   <div class="container">
			      		<div class="row">
			      			...
			      			<div class="col-xs-3">
			      				<span>经 &nbsp;手 &nbsp;人：</span>
			      				<input type="text" name="handler"  class="form-control" value="">
			      			</div>
		      		 	</div>
		      		 </div>
		      		 &nbsp;&nbsp;
			     ...
			     <div class="container">				  
				   	 <div class="row">
			      		...
			      		<div class="col-xs-3">
			      				<span>应返金额：</span>
			      				<input type="text"  class="form-control" name="backfee" id="backfee" required="required">
			      		</div>
			      	</div>		 
			     </div>  
			      &nbsp;&nbsp;   
